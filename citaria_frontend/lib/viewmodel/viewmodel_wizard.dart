...
import 'package:citaria_frontend/dto/dto_empleado_wizard.dart';
import 'package:citaria_frontend/dto/dto_franja_wizard.dart';
import 'package:citaria_frontend/dto/dto_reserva_creada.dart';
import 'package:citaria_frontend/dto/dto_resumen_wizard.dart';
import 'package:citaria_frontend/dto/dto_servicio_wizard.dart';
import 'package:flutter/foundation.dart';
import 'package:intl/intl.dart';

enum OrigenWizard { cliente, admin }

/// Conduce el flujo de creación de una reserva paso a paso: selección de
/// servicios, empleado, fecha, hora y confirmación.
class ViewModelWizard extends ChangeNotifier {
  ...
  //Necesario para que los calendarios se muestren en formato español
  ...
  Future<void> cargarFranjas() async {
    ...
    try {
      ...
      //Prevencion ante clicks rápidos que cambian la fecha antes de cargar las franjas, o respuestas lentas que llegan después de haber cambiado la fecha.  
