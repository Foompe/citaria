...
import 'package:citaria_frontend/dto/dto_usuario_sesion.dart';
...
/// Gestiona la autenticación: login, registro, selección de empresa y el
/// estado de sesión que comparte el resto de la app.
class ViewModelAutenticacion extends ChangeNotifier {
  ...
  Future<void> _comprobarTemaSiEsPosible(
    ...
    try {
      ...
      // Evitamos que la sesion caiga por un fallo al cargar el tema.
    }
  }
