...
import 'package:citaria_frontend/dto/admin/dto_empleado_inicio_admin.dart';
import 'package:citaria_frontend/dto/admin/dto_reserva_inicio_admin.dart';
import 'package:citaria_frontend/viewmodel/admin/viewmodel_admin_base.dart';
import 'package:flutter/foundation.dart';

/// Prepara el resumen de la pantalla de inicio del panel admin.
class ViewModelAdminInicio extends ViewModelAdminBase {
  ...
  Future<List<DtoReservaInicioAdmin>> _crearReservas(
    ...
    // Solo reservas con id; sus detalles se piden en paralelo
