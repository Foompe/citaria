...
class GestorNavegacion {
  ...
  static Future<bool?> irAAdminDetalleServicio(BuildContext context, int id) =>
      _irAPinConDestino<bool>(
        context,
        (_) => PantallaAdminDetalleServicio(id: id),
        'Catálogo',
      );
  ...
  static Future<bool?> irAAdminDetalleCategoria(BuildContext context, int id) =>
      _irAPinConDestino<bool>(
        context,
        (_) => PantallaAdminDetalleCategoria(id: id),
        'Catálogo',
      );
